...
import { updatePlanning } from '../../services/filiereServices';

const EditPlanningModal = ({ id_filiere, planning, semestre, fetchSemestres }) => {
    ...
    const handleSavePlanning = async () => {
        try {
            await updatePlanning(id_filiere, semestre, planning, imagePreview)
            fetchSemestres()
